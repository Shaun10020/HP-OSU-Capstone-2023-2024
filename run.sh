...
## Train the models
python main.py --model=unet --mode=train --batch=8 --epoch=80 --dataset=duplex --lr=1e-3 --lr_decay=0.5 --lr_epoch=25
python main.py --model=enet --mode=train --batch=8 --epoch=80 --dataset=duplex --lr=1e-3 --lr_decay=0.5 --lr_epoch=25
python main.py --model=deeplabv3 --mode=train --batch=8 --epoch=80 --dataset=duplex --lr=1e-3 --lr_decay=0.5 --lr_epoch=25
python main.py --model=deeplabv3+ --mode=train --batch=8 --epoch=80 --dataset=duplex --lr=1e-3 --lr_decay=0.5 --lr_epoch=25
