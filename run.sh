...
## Train the models
python main.py --model=unet --mode=train --batch=8 --epoch=120 --dataset=duplex --lr=1e-4 --lr_decay=0.1 --lr_epoch=30
python main.py --model=enet --mode=train --batch=8 --epoch=120 --dataset=duplex --lr=1e-4 --lr_decay=0.1 --lr_epoch=30
python main.py --model=deeplabv3 --mode=train --batch=8 --epoch=120 --dataset=duplex --lr=1e-4 --lr_decay=0.1 --lr_epoch=30
python main.py --model=deeplabv3+ --mode=train --batch=8 --epoch=120 --dataset=duplex --lr=1e-4 --lr_decay=0.1 --lr_epoch=30
